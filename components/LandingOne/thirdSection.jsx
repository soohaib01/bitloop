...
deploy them in milliseconds.​</p>
      <div className={Styles.ServicesContainer}>
          <div className={Styles.FirstLayer}>
              <ul>
                  <li><div className={Styles.Icon}><img src="/service_icons/Low.png" alt="" className={Styles.Icon}/></div></li>
          ...
          <div className={Styles.FirstLayer} id={Styles.MiddleLayer}>
              <ul>
                  <li><div className={Styles.Icon}><img src="/service_icons/User.png" alt="" className={Styles.Icon}/></div></li>
          ...
          <div className={Styles.FirstLayer}>
              <ul>
                  <li><div className={Styles.Icon}><img src="/service_icons/Monitoring.png" alt="" className={Styles.Icon}/></div></li>
          ...
          <div className={Styles.FirstLayer}>
              <ul>
                  <li><div className={Styles.Icon}><img src="/service_icons/Realtimedatabase.png" alt="" className={Styles.Icon}/></div></li>
...
​</p></div></li>
      ...
      <div className={Styles.ServicesContainer}>
          <div className={Styles.FirstLayer}>
              <ul>
                  <li><div className={Styles.Icon}><img src="/service_icons/Workflow.png" alt="" className={Styles.Icon}/></div></li>
          ...
          <div className={Styles.FirstLayer} id={Styles.MiddleLayer}>
              <ul>
                  <li><div className={Styles.Icon}><img src="/service_icons/Backend.png" alt="" className={Styles.Icon}/></div></li>
