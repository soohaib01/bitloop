...
const mainsection = () => {
  return (
    <div className={MainStyles.TopContainer}>
        ...
        <h1 className={MainStyles.Headingmain}><span className={MainStyles.ColorFull}>Develop</span> backend faster with <span className={MainStyles.ColorFull}>Bitloops</span></h1>
